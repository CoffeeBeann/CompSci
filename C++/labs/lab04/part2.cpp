...
Convert Temperatures to Fahrenheit & Output Stats
**************************************************/
...
int main() 
{
    ...
    int count = 0, year, month, day, minTempYear, minTempMonth, minTempDay, maxTempYear, maxTempMonth, maxTempDay, trash;
    char slash;
    ...
    while (inputFile >> year >> slash >> month >> slash >> day >> trash >> slash >> trash >> slash >> trash >> tempCelsius) 
    {
